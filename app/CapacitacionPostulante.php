...
class CapacitacionPostulante extends Model
{
    ...
    protected $fillable = ['postulante_id','es_curso_espec','es_especializacion','es_diplomado','es_ofimatica','es_idioma','es_certificado','es_licencia','centro_estudios','especialidad',
