...
class DatosPostulante extends Model
{
    ...
    protected $fillable = ['postulante_id','archivo_foto','archivo_dni','archivo_certi_laboral','archivo_certi_laboral_tipo','archivo_dni_tipo','telefono_celular','telefono_fijo','ruc',
