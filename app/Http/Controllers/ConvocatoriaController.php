        ...
        foreach ($query as $dato) {
            if(!$dato->file){
                ...
                if(auth()->check() && auth()->user()->hasRoles(['Comisionado','Administrador'])){
                    ...
                    $postular = '<a class="btn btn-info waves-effect waves-light" href="'.route("postulante_postular",["idproceso" => $idproceso]).'" type="button"><span class="btn-label"><i class="icon-login"></i></span> Postular2</a>';
