...
{	public function __construct()
    ...
    public function data(){
    	return [
			...
			['nombre'=>'nombre del año','valor'=>'Año del Fortalecimiento de la Soberania Nacional','descripcion'=>'Nombre del año actual, aparecerá en los reportes PDF','tipo'=>'texto'],
			['nombre'=>'pie pagina 1','valor'=>'Copyright © 2022 CONVOCATORIA Personal, Todos los derechos Reservados.','descripcion'=>'texto grande','tipo'=>'texto'],
			['nombre'=>'pie pagina 2','valor'=>' Power by UNHEVAL','descripcion'=>'texto pequeño','tipo'=>'texto'],
			...
			['nombre'=>'manual usuario','valor'=>'https://convocatoria.unheval.edu.pe/manual/Manual-Postulante.pdf','descripcion'=>'Manual de usuario','tipo'=>'archivo_ruta'],
