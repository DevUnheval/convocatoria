    ...
    public function data(){
        ...
        foreach ($query as $dato) {
            ...
            $config.= "     <div class='dropdown-menu animated slideInUp' x-placement='bottom-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);'>
                            ...
                            <a class='dropdown-item' href='javascript:void(0)' onclick='ver_evaluacion($dato->id)'><i class='ti-comment-alt'></i> Evaluacion</a>
                            <a class='dropdown-item' href='javascript:void(0)' onclick='resultado($dato->id)'><i class='ti-comment-alt'></i> Resultados</a>
                            </div>
