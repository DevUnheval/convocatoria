                               ...
                               <form class="needs-validation" novalidate>  
                                     ...
                                     <div class="row">
                                       ...
                                       <div class="row">
                                         <div class="col-md-12">
                                             <div class="form-group">
                                                 <label for="documento_formac">Documento de sustento:<small>(solo archivos .pdf - Tamaño máximo de archivo {{$pesoMaxArchivo_c}} MB)</small> <span class="text-danger">*</span> </label>
                                                 <input type="file" class="form-control " id="documento_formac" name="documento_formac" accept="application/pdf" onchange="validar_peso_archivo(this)" required> 
                                             </div>
                                         </div>
                                       </div>
                                       <div class="row">
