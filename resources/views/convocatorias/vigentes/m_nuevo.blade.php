                                            ...
                                            <div class="col-sm-6  border border-secondary rounded">
                                                <div class="row p-2">
                                                    ...
                                                    <div class="col-md-4 col-sm-2 form-group">                                                
                                                        <small>Años</small>
                                                        <input type="number" class="form-control required" name="n_exp_lab_gen_anio" id="n_exp_lab_gen_anio" value="1">
                                                    </div>
                                                    <div class="col-md-4 col-sm-2 form-group">                                                
                                                        <small>Meses</small>
                                                        <input type="number" class="form-control required" name="n_exp_lab_gen_mes" id="n_exp_lab_gen_mes" value="0" max="11">
                                                    </div>
                                                    <div class="col-md-4 col-sm-2 form-group">                                                
                                                        <small>Días</small>
                                                        <input type="number" class="form-control required" name="n_exp_lab_gen_dia" id="n_exp_lab_gen_dia" value="0" max="30">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6  border border-secondary rounded">
                                                <div class="row p-2">
                                                    ...
                                                    <div class="col-md-4 col-sm-2 form-group">                                                
                                                        <small>Años</small>
                                                        <input type="number" class="form-control required"   name="n_exp_lab_esp_anio" id="n_exp_lab_esp_anio" value="1" >
                                                    </div>
                                                    <div class="col-md-4 col-sm-2 form-group">                                                
                                                        <small>Meses</small>
                                                        <input type="number" class="form-control required"   name="n_exp_lab_esp_mes" id="n_exp_lab_esp_mes" value="0" max="11">
                                                    </div>
                                                    <div class="col-md-4 col-sm-2 form-group">                                                
                                                        <small>Días</small>
                                                        <input type="number" class="form-control required"   name="n_exp_lab_esp_dia" id="n_exp_lab_esp_dia" value="0" max="30">
                                                    </div>
                                                </div>
                                            </div>
