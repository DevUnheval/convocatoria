...
<div class="container-fluid note-has-grid"><hr>
    ...
    <div class="p-2">
        ...
        <a class="btn btn-outline-success float-right" href="{{route('reporte.postulantes',$proceso->id)}}" target="_blank"><i class="fa fa-file-excel"></i> Descargar proceso completo </a>
    </div>
