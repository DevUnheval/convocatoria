                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> 
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="{{route('maestro.tipoprocesos.index')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Tipo de Procesos</span></a></li>
