        ...
        onFinished: function(event, currentIndex) {//cuando se termina todos los pasos
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    const anios1 = (365)*$("#n_exp_lab_gen_anio").val();
                    const meses1 = (30.4)*$("#n_exp_lab_gen_mes").val();
                    const dias1  = parseInt($("#n_exp_lab_gen_dia").val(),10);
                    const dias_exp_lab_gen = parseInt( (anios1)+(meses1)+(dias1) , 10);
                    formData.append("dias_exp_lab_gen", dias_exp_lab_gen );
                    //Experiencia laboral específica
                    const anios = (365)*$("#n_exp_lab_esp_anio").val();
                    const meses = (30.4)*$("#n_exp_lab_esp_mes").val();
                    const dias  = parseInt($("#n_exp_lab_esp_dia").val(),10);
